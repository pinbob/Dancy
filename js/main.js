...
function showScene(index){
	...
	case 1:
		//Who(red)
		$("#mainScene").html("<h1>WHO made it</h1><p>Dancy is <a href='https://github.com/pinbob' target='_blank'>PinBob</a>'s team work.<br><br>Team member includes:<br><a href='https://github.com/styx-hy'>∫È—Ô</a>: tcsyxx6350@gmail.com<br><a href='https://github.com/liwenhaosuper'>¿˚Œƒ∫∆</a>: liwenhaosuper@126.com<br><a href='https://github.com/alpha360x' target='_blank'>“∂º“±Ú</a>: alpha360x@gmail.com<br><a href='https://github.com/Ovilia' target='_blank'>’≈ˆ©¿Ú</a>: zwl.sjtu@gmail.com</p><img src='images/pinbob.png' style='float: right; position: relative; top: -200px;' />");
