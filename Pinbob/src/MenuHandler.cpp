...
void MenuHandler::drawScene() {
	...
	m_pDriver->draw2DImage(
			...
			core::rect<s32>(0, 0,
					m_pDevice->getVideoDriver()->getScreenSize().Width,
...
//  			}
				...
				this->m_pStateMachine->currentDevice = 0;
				m_lastfocusItem = MAIN_MENU_STATE;
				return MAIN_MENU_STATE;
			}
			break;
