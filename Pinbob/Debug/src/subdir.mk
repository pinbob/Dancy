...
src/%.o: ../src/%.cpp
	...
	g++ -DTEST_ARMANAGER -DTEST_ALL -D_DEBUG -I/home/nuedc/Meego/irrlicht-1.7.2/include -I/home/nuedc/Meego/irrKlang-1.3.0/include -I/home/nuedc/Meego/ARToolKit/include -O2 -g3 -Wall -c -fmessage-length=0 -Wno-write-strings `pkg-config --cflags --libs gstreamer-0.10` -pthread -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
